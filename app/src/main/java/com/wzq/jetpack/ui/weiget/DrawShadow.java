 ...
 */
public class DrawShadow extends Drawable {
    ...
    public DrawShadow(Resources resources, ColorStateList backgroundColor, float radius,
                                float shadowSize, float maxShadowSize) {
        mShadowStartColor = resources.getColor(R.color.colorPrimary);
        mShadowEndColor = resources.getColor(R.color.white);
        mInsetShadow = resources.getDimensionPixelSize(R.dimen.shadow);
